...
def check_sanity(e):
	...
	#MobiAqua: added: wget, intltoolize; removed md5sum chrpath
	required_utilities = "patch diffstat texi2html makeinfo cvs svn bzip2 tar gzip gawk wget intltoolize"
