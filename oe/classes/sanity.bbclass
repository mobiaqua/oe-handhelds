...
def check_sanity(e):
	...
	#MobiAqua: added: wget, intltoolize, python, perl; removed md5sum chrpath
	required_utilities = "patch diffstat texi2html makeinfo cvs svn bzip2 tar gzip gawk wget intltoolize python perl"
