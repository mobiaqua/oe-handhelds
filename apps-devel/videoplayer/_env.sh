...
export DCE_LDFLAGS="-lipc -ldce -ltimemmgr -lsysmgr -lrcm -lsyslinknotify -lprocmgr"
export AV_CFLAGS=""
export AV_LDFLAGS="-lpthread -lavformat -lavcodec"
export PVR_CFLAGS="-I$sysroot/usr/include/pvr2d"
export PVR_LDFLAGS="-lpvrPVR2D_DRIWSEGL"
export GLES_CFLAGS=""
